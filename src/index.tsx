...
console.log('nativeModules:', NativeModules.EscPosPrinter);
console.log('BluetoothManagernativeModules:', NativeModules.BluetoothManager);
...
const BluetoothManager = NativeModules.BluetoothManager
  ...
  : new Proxy(
    ...
    {
      get() {
        throw new Error("BluetoothManager error:", JSON.stringify(NativeModules));
      },
    }
  );

const BluetoothEscposPrinter = NativeModules.BluetoothEscposPrinter
...
const BluetoothTscPrinter = NativeModules.BluetoothTscPrinter
...
//   return EscPosPrinter.multiply(a, b);
// }
