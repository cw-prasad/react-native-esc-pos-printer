...
package com.escposprinter.escpos;

import android.graphics.Bitmap;
import android.graphics.BitmapFactory;
import android.util.Base64;
import android.util.Log;
import com.escposprinter.BluetoothService;
import com.escposprinter.BluetoothServiceStateObserver;
import com.escposprinter.escpos.command.sdk.Command;
import com.escposprinter.escpos.command.sdk.PrintPicture;
import com.escposprinter.escpos.command.sdk.PrinterCommand;
...
@ReactModule(name = RNBluetoothEscposPrinterModule.NAME)
public class RNBluetoothEscposPrinterModule extends ReactContextBaseJavaModule
    ...
    @ReactMethod
    public void isSDKConnected(final Promise promise){
            promise.resolve("connectedAndroid");
    }
